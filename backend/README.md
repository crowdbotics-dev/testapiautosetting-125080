...
## Project Structure
    ...
    ├── testapiautosetting_125080  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125080`
...
2. Clone this repo and `cd testapiautosetting_125080`
